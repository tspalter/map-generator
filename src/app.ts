...
const argv: Arguments = yargs(process.argv.slice(2))
  .options({
    ...
    minordsep: { type: 'number', default: 20 },
    minordtest: { type: 'number', default: 15},
    ...
    majordsep: { type: 'number', default: 100 },
    majordtest: { type: 'number', default: 30},
    ...
    maindsep: { type: 'number', default: 400 },
    maindtest: { type: 'number', default: 200},
    ...
    coastdtest: { type: 'number', default: 15},
    ...
    buildingminArea: { type: 'number', default: 50},
